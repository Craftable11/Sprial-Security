...
public class Colours {
    ...
    public static final String TEXT_COLOUR_PREFIX_BLUE = "\u00a71";
    public static final String TEXT_COLOUR_PREFIX_BLACK = "\u00a70";
    public static final String TEXT_COLOUR_PREFIX_ORANGE = "\u00a76";
