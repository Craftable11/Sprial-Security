...
public class CommandSounds {
    ...
    private static void processAllCommand(ICommandSender commandSender) {
        ...
        ConfigurationHandler.set(ConfigurationHandler.CATEGORY_AUDIO,
                ConfigurationSettings.ENABLE_SOUNDS_CONFIGNAME, Commands.ALL);
        commandSender.sendChatToPlayer(ChatMessageComponent
                .func_111077_e(Commands.COMMAND_SOUNDS_SET_TO_ALL));
    }
    ...
    private static void processSelfCommand(ICommandSender commandSender) {
        ...
        ConfigurationHandler.set(ConfigurationHandler.CATEGORY_AUDIO,
                ConfigurationSettings.ENABLE_SOUNDS_CONFIGNAME, Commands.SELF);
        commandSender.sendChatToPlayer(ChatMessageComponent
                .func_111077_e(Commands.COMMAND_SOUNDS_SET_TO_SELF));
    }
    ...
    private static void processOffCommand(ICommandSender commandSender) {
        ...
        ConfigurationHandler.set(ConfigurationHandler.CATEGORY_AUDIO,
                ConfigurationSettings.ENABLE_SOUNDS_CONFIGNAME, Commands.OFF);
        commandSender.sendChatToPlayer(ChatMessageComponent
                .func_111077_e(Commands.COMMAND_SOUNDS_TURNED_OFF));
    }
}
