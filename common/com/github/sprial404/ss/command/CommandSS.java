        ...
        switch (args.length) {
            case 1: {
                return getListOfStringsMatchingLastWord(args, new String[] {
                        Commands.COMMAND_PARTICLES, Commands.COMMAND_SOUNDS,
            ...
            case 2: {
                if (args[0].equalsIgnoreCase(Commands.COMMAND_PARTICLES))
                    ...
                    return getListOfStringsMatchingLastWord(args, new String[] {
                            Commands.ALL, Commands.COMMAND_SELF,
                            Commands.COMMAND_OFF });
                else if (args[0].equalsIgnoreCase(Commands.COMMAND_VERSION))
                    return getListOfStringsMatchingLastWord(args,
                            new String[] { Commands.COMMAND_CHANGELOG });
            }
            default: {
                return null;
            }
    ...
    public void processCommand(ICommandSender commandSender, String[] args) {
        if (args.length > 0) {
            ...
            if (commandName.equalsIgnoreCase(Commands.COMMAND_PARTICLES)) {
                ...
                throw new WrongUsageException(Commands.COMMAND_SS_USAGE,
                        new Object[0]);
        } else
            throw new WrongUsageException(Commands.COMMAND_SS_USAGE,
                    new Object[0]);
